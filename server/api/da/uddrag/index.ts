...
export default defineEventHandler(() => {
  const uddrag1 = [
    ...
    { id: 106182, postil: 'Trinity II', tags: 'Evangelium', label: '18.Søn.e.Tref.', bible: 'Matt 22: 34-46', value: '/da/trinity2/gospel18', description: 'I denne prædiken fordømmer Luther de som hevder at "Når du blot tror, så bliver du frelst." I neste setnig svarer han "Nej, min gode mand, den går ikke! Du kommer ikke ind i Himmerige."' }
